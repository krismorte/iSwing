...
public class Tabela extends JPanel {
    ...
    /**
     * Busca por um valor em todas as colunas
     *
     * @param texto
     * @return
     *
     * public static Object[][] buscaValores(String texto) { Object[][]
     * linhasTmp = null; List<Object[]> list = new ArrayList<Object[]>(); for
     * (Object[] o : linhas) { for (int i = 0; i < o.length; i++) { if
     * (o[i].toString().toUpperCase().trim().contains(texto.toUpperCase().trim()))
     * { //System.out.println("Vlr " + o[i].toString()); list.add(o); break; } }
     * } if (list.isEmpty()) { //System.out.println("Vazio"); linhasTmp = new
     * Object[0][colunas.length]; } else { //System.out.println("Não Vazio");
     * //System.out.println("Total: "+list.size()); linhasTmp = new
     * Object[list.size()][colunas.length];
     *
     * for (int i = 0; i < list.size(); i++) { //System.out.println("I"); for
     * (int z = 0; z < colunas.length; z++) { //System.out.println("Z");
     * //System.out.println("Vlr "+list.get(i)[z].toString()); //Object[][] obj
     * = {{lista.get(i).getSistema(), lista.get(i)}}; linhasTmp[i][z] =
     * list.get(i)[z]; } } } return linhasTmp; }
     */
    /**
     * *
     * Buscar por uma valor em uma coluna especifica
     *
     * @param texto
     * @param coluna
     * @return
     *
     * public static Object[][] buscaValores(String texto, int coluna) {
     * Object[][] linhasTmp = null; List<Object[]> list = new
     * ArrayList<Object[]>(); for (Object[] o : linhas) { //for (int i = 0; i <
     * o.length; i++) { if
     * (o[coluna].toString().toUpperCase().trim().contains(texto.toUpperCase().trim()))
     * { //System.out.println("Vlr " + o[i].toString()); list.add(o); //break; }
     * //} } if (list.isEmpty()) { //System.out.println("Vazio"); linhasTmp =
     * new Object[0][colunas.length]; } else { //System.out.println("Não
     * Vazio"); //System.out.println("Total: "+list.size()); linhasTmp = new
     * Object[list.size()][colunas.length];
     *
     * for (int i = 0; i < list.size(); i++) { //System.out.println("I"); for
     * (int z = 0; z < colunas.length; z++) { //System.out.println("Z");
     ...
     */
    /**
     * Buscar por um valor especifico em todas as colunas recebendo as colunas e
     * linhas e o texto buscado
     *
     * @param colunas
     * @param linhas
     * @param texto
...
/**
 * Buscar por um valor especifico em colunas especifica as colunas e
 * linhas e o texto buscado
 * 
 * @param colunas
 * @param linhas
 ...
 * @return 
 */
    public static Object[][] buscaValores(String[] colunas, Object[][] linhas, String texto, int coluna) {
        Object[][] linhasTmp = null;
        List<Object[]> list = new ArrayList<Object[]>();
        for (Object[] o : linhas) {
            //for (int i = 0; i < o.length; i++) {
